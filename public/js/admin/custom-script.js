/******/ (function (modules) {
  ...
  \***********************************/
		...
		/***/ "./resources/js/admin/custom-script.js":
			/*!*********************************************!*\
  !*** ./resources/js/admin/custom-script.js ***!
  \*********************************************/
			/*! no static exports found */
...
WE WILL RELEASE FUTURE UPDATES SO IN ORDER TO NOT OVERWRITE YOUR CUSTOM SCRIPT IT'S BETTER LIKE THIS. */
				...
				if ($(".dropzone").length) {
					Dropzone.options.myAwesomeDropzone = {
						...
						init: function init() {
							...
							this.on("sendingmultiple", function () {
								console.log("Dropzone Sending Multiple..."); // Gets triggered when the form is actually being sent.
								// Hide the success button or the complete form.
							});
							this.on("successmultiple", function (files, response) {
								console.log("Dropzone Success: ".concat(response)); // Gets triggered when the files have successfully been sent.
								// Redirect user or notify of success.
							});
							this.on("errormultiple", function (files, response) {
								console.log("Dropzone Error: ".concat(response)); // Gets triggered when there was an error sending the files.
							...
							this.on("removedfile", function (file) {
								console.log("Dropzone File Removed! ".concat(file.id));
					...
					$(".media-edit-actions .edit").on("click", function () {
						...
						$(".dropzone-previews .dz-preview input:checkbox").prop(
							"disabled",
							false
						);
					...
					$(".dropzone-previews").on(
						"change",
						".dz-preview input:checkbox",
						function () {
							if (
								$(".dropzone-previews .dz-preview input:checkbox:checked")
									.length != 0
							) {
				...
				$(document).ready(function () {
					...
					$orgProfileTabNames = [
						"",
						"tab=about",
						"tab=registration-place",
						"tab=organization-types",
						"tab=activity-areas",
						"tab=activity-fields",
						"tab=contact",
						"tab=password",
						"tab=subscripted-orgs",
						"tab=subscripted-categories",
					];
					$(".profile-wrapper .sidebar .sidebar-item").on("click", function () {
						...
						$('.profile-wrapper .tab[data-tab-index="' + index + '"]').addClass(
							"active"
						);
					...
					if (
						$("#description_ka").length &&
						!$("#description_ka").hasClass("limited-editor")
					) {
						ClassicEditor.create(document.querySelector("#description_ka"), {
							mediaEmbed: {
								previewsInData: true,
							},
							ckfinder: {
					...
					if ($(".limited-editor").length) {
						ClassicEditor.create(document.querySelector("#description1_ka"), {
							toolbar: [
								"heading",
								"bold",
								"italic",
					...
					$(".registration-place-toggle input").on("change", function () {
						if ($(".registration-place-toggle .left input").is(":checked")) {
							$(".registration-place-toggle")
								.parent()
								.find(".toggle-left")
								.removeClass("disabled");
							$(".registration-place-toggle")
								.parent()
								.find(".toggle-left input")
								.removeAttr("disabled");
							$(".registration-place-toggle")
								.parent()
								.find(".toggle-right")
							...
							if (
								...
								$(".registration-place-toggle")
									.parent()
									.find(".toggle-left + div")
									.removeClass("disabled");
								$(".registration-place-toggle")
									.parent()
									.find(".toggle-left + div input")
									.removeAttr("disabled");
							}
							...
							$(this)
								...
								.find(".is-local")
								.find("input:text")
								.not(".ignore-input-text")
								.attr("pattern", ".{1}");
							$(this)
								.closest("form")
								.find(".is-international input:text")
								.removeAttr("pattern");
						} else {
							$(".registration-place-toggle")
								.parent()
					...
					$(".same-address-wrapper .toggle-container input").on(
						"change",
						function () {
							if (
								$(".same-address-wrapper .toggle-container  .left input").is(
									":checked"
								)
							) {
								$(".factual-address-wrapper").addClass("disabled");
								$(".factual-address-wrapper input").attr(
									"disabled",
									"disabled"
								);
					...
					$(".tab--working-types .sub-item input").on("change", function (e) {
						...
						if ($(this).is(":checked")) {
							$('.tab--working-types .subtype[type-id="' + id + '"]').addClass(
								"active"
							);
						} else {
							$(
								'.tab--working-types .subtype[type-id="' + id + '"]'
							).removeClass("active");
						}
					});
					...
					$(".add-file-input").on("click", function (e) {
						...
						setTimeout(function () {
							$(".file-inputs .file-field:last-child input").on(
								"blur",
								function () {
									if ($(this).val() == "") {
					...
					$(".uploader-container input#opportunity-pic").on(
						"change",
						function () {
							if ($(this).val() != "") {
								$(this)
					...
					$(document).on(
						...
						function () {
							$this = $(this);
							$(".popup-delete-confirm .title-text").text(
								"გსურთ ფაილის წაშლა?"
							);
					...
					$(".file-inputs-wrapper .remove-all-file-inputs").on(
						"click",
						function () {
					...
					function switchTab(index) {
						...
						$(
							".opportunity-page .sidebar .circle, .opportunity-page .sidebar .line"
						).removeClass("active");
						$(
							".opportunity-page .sidebar .circle, .opportunity-page .sidebar .line"
						).removeClass("past");
						...
						for (var i = 1; i < index; i++) {
							$(
								'.opportunity-page .sidebar .circle[data-tab-index="' +
									i +
									'"], .opportunity-page .sidebar .line[data-tab-index="' +
									i +
									'"]'
							).addClass("past");
						}
						...
						$(
							'.opportunity-page .tab[data-tab-index="' + index + '"]'
						).addClass("active");
						$(
							'.opportunity-page .sidebar .sidebar-item[data-tab-index="' +
								index +
								'"]'
						).addClass("active");
					}
					...
					$(".opportunity-page .sidebar .sidebar-item").on(
						"click",
						function () {
							var index = parseInt($(this).data("tab-index"));
							switchTab(index);
					...
					$(".opportunity-page .next-step-button").on("click", function () {
						var index = parseInt(
							$(".opportunity-page .tab.active").data("tab-index")
						);
						switchTab(index + 1);
					});
					...
					function opportunityValidation() {
						$requiredChechboxes = $(".opportunity-page .tab.active")
							.prevAll(".tab")
							.addBack()
						...
						$requiredTabInputs = $(".opportunity-page .tab.active")
							.prevAll(".tab")
							.addBack()
							.find(".form__input");
						...
						if (!$editorFilled) {
							$(
								".opportunity-page .tab.active .contains-editor .form__tooltip--error"
							).addClass("active");
					...
					$('.registration-types .registration-type input[type="radio"]').on(
						"change",
						function () {
							if ($(this).prop("checked")) {
								...
								if ($(this).hasClass("right")) {
									...
									$(this)
										...
										.removeClass("hidden");
									$(
										".registration-types .registration-type.left-type"
									).removeClass("active");
								} else {
									$(
										".registration-types .registration-type.right-type"
									).removeClass("active");
									$(
										'.registration-types .registration-type.right-type input[type="text"]'
									).attr("disabled", "true");
									$(
										".registration-types .registration-type.right-type .form__tooltip"
									).addClass("hidden");
								}
							}
						}
					);
					$('.event-types .event-type input[type="radio"]').on(
						"click",
						function () {
							$(this)
								.closest(".event-types")
							...
							if ($(this).hasClass("right")) {
								...
								$(this)
									.closest(".tab")
									.find(".opportunity-location-wrapper")
									.addClass("disabled");
								$(this)
									.closest(".tab")
									.find(".opportunity-location-wrapper input:text")
									.prop("disabled", true);
								$(this)
									.closest(".tab")
									.find(".opportunity-location-wrapper input:text")
					...
					$(".age-row .checkbox-container input").on("change", function () {
						if ($(this).prop("checked")) {
							var inputForm = $(this).parents(".age-row").find(".form__group");
							...
							var _inputForm = $(this).parents(".age-row").find(".form__group");

							_inputForm.removeClass("disabled");

							_inputForm.find("input").removeAttr("readonly");

							_inputForm.find("input").val("");

							_inputForm.find("input").attr("pattern", ".{1}");

							_inputForm.find("input").prop("disabled", false);
						}
					});
					$('.sidebar-item[data-tab-index="5"], .next-step-button').on(
						"click",
						function (e) {
							e.preventDefault();
					...
					if ($viewportWidth <= 991) {
						$('.menu-mobile-item[data-tab-index="5"]').on(
							"click",
							function (e) {
								setTimeout(function () {
									configMap("map", true);
					...
					$(".faq-new .add-faq").on("click", function () {
						...
						$(".faq-added").append(
							'\n            <div class="faq-added-single faq-single mb-2">\n                <div class="faq-question">\n                    <input type="text" name=\'faq_question[]\' class=\'faq-input\' value="' +
								$question +
								"\" readonly>\n                </div>\n                <div class=\"faq-answer\">\n                    <textarea class='faq-input faq-textarea' name='faq_answer[]' value=\"" +
								$answer +
								'" readonly>' +
								$answer +
					...
					$(".faq-added").on("click", ".edit-faq", function () {
						...
						$(this)
							.parent()
							.find(".save-edit-faq, .cancel-edit-faq")
							.addClass("active");
					...
					$(".select2-regions").on("change", function () {
						$(".select2-regions option").each(function () {
							if (!$(this).prop("selected")) {
								$(
									'.select2-municipalities option[data-region-id="' +
										$(this).attr("value") +
										'"]'
								).addClass("invisible");
								$(
						...
						for (var i = 0; i < values.length; i++) {
							var value = values[i];
							$(
								'.select2-municipalities option[data-region-id="' + value + '"]'
					...
					$(".select2-types").on("change", function () {
						$(".select2-types option").each(function () {
							if (!$(this).prop("selected")) {
								$(
									'.select2-subtypes option[data-type-id="' +
										$(this).attr("value") +
										'"]'
								).addClass("invisible");
								$(
						...
						for (var i = 0; i < values.length; i++) {
							var value = values[i];
							$(
								'.select2-subtypes option[data-type-id="' + value + '"]'
							).removeClass("invisible");
						}
					});
					...
					$(".delete-media").on("click", function (e) {
						...
						var input =
							'<input type="hidden" name="removed_media[]" value="' +
							path +
							'"></input>';
      ...
      CKEDITOR.replace('description1_ka');
       ...
       CKEDITOR.replace('address_en');
					...
					$(".has-option-other input:radio").on("click", function () {
						$(this)
							.closest("form")
							.find(".option-other input:checkbox")
							.prop("checked", false)
							.change();
					});
						...
						$(".menu-mobile-admin .menu-mobile-item").on("click", function () {
							if (!$(this).hasClass("current")) {
								...
								if ($(".profile-wrapper").length) {
									...
									var index = $(this).data("tab-index");
									$(
										'.profile-wrapper .tab[data-tab-index="' + index + '"]'
									).addClass("active");
									var pageUrl = "?" + $orgProfileTabNames[index];
									window.history.pushState("", "", pageUrl);
								} else if ($(".opportunity-page").length) {
									_index = (_readOnlyError("index"), $(this).data("tab-index"));
									...
									var _index = $(this).data("tab-index");

									$(
										'.opportunity-page .tab[data-tab-index="' + _index + '"]'
									).addClass("active");
									oppTitleVisibility(_index);
								} // $('.profile-wrapper .tab').removeClass('active');
					...
					$(".uploader-container input.raw-file-input").on(
						"change",
						function () {
							if ($(this).val() != "") {
								$(this)
					...
					$(".cropper-popup-trigger").on("click", function () {
						if ($(".popup-resizable-pic").hasClass("popup-active")) {
							var renderedRawWrapper = document.querySelector(
									".popup-active .rendered-raw-wrapper"
								),
								renderedRawContainer = document.querySelector(
									".popup-active .rendered-raw-container"
								),
								croppedContainer = document.querySelector(
									".popup-active .cropped-container"
								),
								cropButton = document.querySelector(
									".popup-active .crop-button"
								),
								croppedImage = document.querySelector(
									".popup-active .cropped-image"
								),
								upload = document.querySelector(
									".popup-active .raw-file-input"
								);
							cancelImage = document.querySelector(".popup-active .img-cancel"); // on change show image with crop options
									...
									if (e.target.files.length) {
										...
										reader.onload = function (e) {
											if (e.target.result) {
												...
												renderedRawWrapper.innerHTML = ""; // append new image
							...
							if (noCroppListener) {
								...
								cropButton.addEventListener("click", function (e) {
									...
									globalImageSrc = imgSrc; // remove hide class of img

									renderedRawContainer.classList.remove("active");
									croppedContainer.classList.add("active"); // show image cropped

									croppedImage.src = imgSrc;
									$("#org-profile-image").val(imgSrc); // dwn.classList.remove('hide');
							...
							$(".img-cancel").on("click", function () {
								$(".popup-active")
									.find(".rendered-raw-container")
									.removeClass("active");
								$(".popup-active")
									.find(".cropped-container")
									.removeClass("active");
								$(".popup.popup-active .raw-file-input")
									.val("")
									.trigger("change");
					...
					var listenToUpload = true;
					$(".opp-image-upload").on("click", function () {
						var renderedRawWrapper = document.querySelector(
								".opp-image-section .rendered-raw-wrapper"
							),
							renderedRawContainer = document.querySelector(
								".opp-image-section .rendered-raw-container"
							),
							croppedContainer = document.querySelector(
								".opp-image-section .cropped-container"
							),
							cropButton = document.querySelector(
								".opp-image-section .crop-button"
							),
							croppedImage = document.querySelector(
								".opp-image-section .cropped-image"
							),
							upload = document.querySelector("#opp-image-file"),
							deleteImage = document.querySelector(
								".opp-image-section .opp-image-remove"
							),
							enableCrop = document.querySelector(
								".opp-image-section .enable-crop"
							),
							cropper = null;
						upload.click();
						$this = this;
					...
					var coverHasBeenActivated = true;
					$(".add-cover").on("click", function () {
						var renderedRawWrapper = document.querySelector(
								".cover-wrapper .rendered-raw-wrapper"
							),
							renderedRawContainer = document.querySelector(
								".cover-wrapper .rendered-raw-container"
							),
							croppedContainer = document.querySelector(
								".cover-wrapper .cropped-container"
							),
							cropButton = document.querySelector(
								".cover-wrapper .crop-button"
							),
							croppedImage = document.querySelector(
								".cover-wrapper .cropped-image"
							),
					...
					if ($viewportWidth > 991) {
						$(
							".select-section .municipalities-dropdown .checkbox-container"
						).on("click", function () {
							if (
								!$(this)
								...
								$dataId = $(this)
									.closest(".municipality-section")
									.data("region-id");
								// $(this).closest(".municipality-section").removeClass("active");
								// $(this)
								// 	.closest(".select-section")
								// 	.find(".regions input:checkbox[data-id =" + $dataId + "]")
								// 	.prop("checked", false);

								if (
									!$(this)
										.closest(".select-section")
										.find(".regions input:checkbox:checked").length
								) {
									$(this)
										.closest(".select-section")
										.find(".uncheck-all")
					...
					if ($(".opportunity-edit").length || $(".profile-page").length) {
						$(".tab .filter__dropdown").each(function () {
							$checkboxesCount = $(this).find(
								".checkbox-container:not(.all-checkmark) input:checkbox"
							).length;
							$checkboxesCheckedCount = $(this).find(
								".checkbox-container:not(.all-checkmark) input:checkbox:checked"
							).length;

							if ($checkboxesCount == $checkboxesCheckedCount) {
								$(this)
									.find(".all-checkmark input:checkbox")
									.prop("checked", true);
							} else if (
								$checkboxesCheckedCount != 0 &&
								$checkboxesCheckedCount < $checkboxesCount
							) {
					...
					$(".see-user-message").on("click", function () {
						...
						if (!$(this).closest("tr").find(".anonymous").length) {
							...
							$(".popup-user-feedback .user-name .name").text(
								$firstName + " " + $lastName
							);
							...
							$(".popup-user-feedback .user-name .blue").removeClass("active");
							$(".popup-user-feedback .user-name .not-public").addClass(
								"active"
							);
							$(".popup-user-feedback .user-message").text($message);
							$(".popup-user-feedback").addClass("popup-active");
					...
					$("#main-form .save-opp-editing, #main-form .submit-button").on(
						"click",
						function () {
				...
				function configMap(id, isInteractive) {
					...
					var setLat = $("input#latitude").val();
					var setLng = $("input#longitude").val();
				...
				var oppId = pageURL.substr(pageURL.lastIndexOf("/") + 1); // $('.has-option-other input:radio').on('click', function () {
		...
		/***/ 2:
			/*!***************************************************!*\
  !*** multi ./resources/js/admin/custom-script.js ***!
  \***************************************************/
			/*! no static exports found */
			/***/ function (module, exports, __webpack_require__) {
				module.exports = __webpack_require__(
					/*! /Users/kobakareli/code/youth/resources/js/admin/custom-script.js */ "./resources/js/admin/custom-script.js"
				);

    ...
    <div class="wrapper">
      ...
      <div class="library-grid">
        <div class="library-card  align-items-center justify-content-center">
          ...
          <a href="{{ route('library_in') . '#tab=literature-catalog' }}">განაგრძე</a>
        </div>
        <div class="library-card  align-items-center justify-content-center">
          ...
          <a href="{{ route('library_in') . '#tab=research-catalog' }}">განაგრძე</a>
        </div>
        <div class="library-card align-items-center justify-content-center">
          ...
          <a href="{{ route('library_in') . '#tab=study-cabinet' }}">განაგრძე</a>
        </div>
      </div>
    </div>
	</section>
